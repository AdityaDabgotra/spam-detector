...
## 📂 Project Structure
Spam_detector/ <br>
│── emails.csv # Dataset <br>
│── index.py # Main script <br>
│── spam_nb_model.pkl # Saved model (after training) <br>
│── spam_tfidf.pkl # Saved TF-IDF transformer <br>
│── spam_vocab.pkl # Saved vocabulary <br>
